...
export class DbservicioService {
  ...
  tablaViaje: string = "CREATE TABLE IF NOT EXISTS viaje(idviaje INTEGER PRIMARY KEY , inicio VARCHAR (50) , destino VARCHAR (50)  , asientos INTEGER , costo_viaje INTEGER  , fecha_viaje VARCHAR(30)  , hora_partida INTEGER , hora_llegada INTEGER , fk_patente INTEGER,FOREIGN KEY (fk_patente) REFERENCES auto(patente) , fk_id_usuario INTEGER,FOREIGN KEY(fk_id_usuario) REFERENCES usuario(idusuario));";
